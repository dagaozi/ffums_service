...
基础效验器
 * @Author: dagaozi 
 * @Date: 2019-09-25 16:32:14 
 * @Last Modified by: dagaozi
 * @Last Modified time: 2019-10-13 19:46:50
 *第一个参数可选择参见 https://github.com/validatorjs/validator.js
 */

const validator = require('validator')
const { ParameterException } = require('../model/http-exception')
...
class Validator {
  ...
  validate(ctx, alias = {}) {
    ...
    if (errorMsgs.length != 0) {
      throw new ParameterException(errorMsgs.join())
    }
    ctx.v = this
    return this
  }
